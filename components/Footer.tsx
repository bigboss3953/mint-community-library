      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-1 text-mint-100 text-sm">
              <li><a href="tel:+1234567890" className="hover:text-mint-400 transition-colors">(123) 456-7890</a></li>
              <li><a href="mailto:info@mintlibrary.com" className="hover:text-mint-400 transition-colors">info@mintlibrary.com</a></li>
        ...
        <div className="border-t border-mint-800 mt-8 pt-8 text-center text-mint-200 text-sm">
          <p>&copy; 2024 Mint Community Library. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
