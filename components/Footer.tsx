        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-heading font-bold text-lg">Mint Library</span>
            </div>
            <p className="text-mint-100 text-sm">Serving our community with knowledge, resources, and connection.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-mint-100 text-sm">
              <li><Link href="/" className="hover:text-mint-400 transition-colors">Home</Link></li>
              <li><Link href="/programs" className="hover:text-mint-400 transition-colors">Programs</Link></li>
              <li><Link href="/resources" className="hover:text-mint-400 transition-colors">Resources</Link></li>
              <li><Link href="/about" className="hover:text-mint-400 transition-colors">About Us</Link></li>
            </ul>
          </div>

          {/* Hours */}
          <div>
            <h3 className="font-heading font-bold mb-4">Hours</h3>
          ...
          <div>
            ...
            <ul className="space-y-1 text-mint-100 text-sm">
              <li><a href="tel:+2349166770756" className="hover:text-mint-400 transition-colors">(234) 9166770756</a></li>
              <li><a href="mailto:mintcommunitylibrary@gmail.com" className="hover:text-mint-400 transition-colors">mintcommunitylibrary@gmail.com</a></li>
              <li>3 Sir BE OBIELI STREET
ACHINA, AGUATA LGA
ANAMBRA STATE
NIGERIA</li>
            </ul>
        ...
        <div className="border-t border-mint-800 pt-8 flex justify-center gap-6">
          <a href="#" className="text-mint-400 hover:text-mint-300 transition-colors">
        ...
        <div className="border-t border-mint-800 mt-8 pt-8 text-center text-mint-200 text-sm">
          <p>&copy; 2025 Mint Community Library. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
