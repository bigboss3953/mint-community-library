export default function Programs() {
  const programs = [
    ...
    {
      id: 3,
      title: 'Adult Learning Classes',
      description: 'From digital literacy to creative writing—explore courses designed for adult learners.',
    ...
    },
    {
      ...
      description: 'Entrepreneurship, networking, and professional development sessions.',
    ...
    },
    {
      ...
      description: 'Join fellow writers for feedback, inspiration, and community.',
